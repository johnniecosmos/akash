...
func (_m *ReadClient) LeaseEvents(_a0 context.Context, _a1 types.LeaseID, _a2 bool) (cluster.EventsWatcher, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 cluster.EventsWatcher
	if rf, ok := ret.Get(0).(func(context.Context, types.LeaseID, bool) cluster.EventsWatcher); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
