...
// LeaseEvents provides a mock function with given fields: _a0, _a1, _a2
func (_m *Client) LeaseEvents(_a0 context.Context, _a1 types.LeaseID, _a2 bool) (clustertypes.EventsWatcher, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 clustertypes.EventsWatcher
	if rf, ok := ret.Get(0).(func(context.Context, types.LeaseID, bool) clustertypes.EventsWatcher); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, types.LeaseID, bool) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
